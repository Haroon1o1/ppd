...
import 'package:crop_disease_detection/sign_up.dart';

import 'package:crop_disease_detection/widgets/textfield.dart';
        ...
        Container(
          ...
          child: ElevatedButton(
            onPressed: () {
              ...
              context,
              MaterialPageRoute<void>(
                builder: (BuildContext context) =>  SignUpScreen(title: '',),
              ),
            );
            },
            child: Text(
